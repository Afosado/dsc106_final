...
let line = {
    ...
    subtitle: {
        text: 'Combined Market Capitalization of Top 5 Cryptocurrenies and Google Searches for Cyptocurrency, '
    },
...
let barBit = {
    ...
    title:{
        text:'Bitcoin Price Fluctuation From August 1-December 3, 2019'
    },
    xAxis: {
...
function submission (e) {
    ...
    elem = document.getElementById('totalInv');
    elem.innerText =  'Total Investment: ' + '$' + Math.abs(total).toFixed(0);
    e.preventDefault();
}
...
function onSuccessInt (jsonData) {
    ...
    marketSer.push({
        name:'"Cryptocurrency" Google Search Frequency',
        data:interest
    });
    for (s in marketSer) {
...
function myLoop() {
    ...
    setTimeout(function (){
        ...
        if (counter < barChangeData.length) {
            ...
            startMoney = 10000;
            counter = 0;
            document.getElementById('meme').innerHTML = '<img src="assets/meme.jpg" height="400"></img>'
        }   
    }, 100);
}
